...
#define	my_isalpha(s, c)		((c>='a' && c<='z') || (c>='A' && c<='Z'))
#define	my_isdigit(s, c)		(c>='0' && c<='9')
#define	my_isxdigit(s, c)		((c>='0' && c<='9') || (c>='A' && c<='F') || c>='a' && c<='f')
#define	my_isalnum(s, c)		(my_isalpha(s, c) || my_isdigit(s, c))
