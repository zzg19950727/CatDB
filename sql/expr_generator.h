...
namespace CatDB {
    ...
    namespace Sql {
        ...
        struct ExprGenerateCtx {
            ...
            HashMap<SubQueryStmt_s, LogicalOperator_s> subplan_map;
        ...
        protected:
            ...
            static u32 generate_exec_params(ExprGenerateCtx &ctx, Vector<ExecParamStmt_s> &exprs, Vector<Expression_s> &rt_exprs);
        };
    }
}
