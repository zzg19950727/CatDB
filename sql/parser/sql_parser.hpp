  ...
  public:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_NO_WIN_MAGIC = 356,
        TOKEN_NUMERIC_SYM = 357,
        TOKEN_ON = 358,
        TOKEN_ORDER = 359,
        TOKEN_ORDERED = 360,
        TOKEN_OUTER = 361,
        ...
        TOKEN_MAX = 407,
        TOKEN_RANK = 408,
        TOKEN_DENSE_RANK = 409,
        TOKEN_ROW_NUMBER = 410,
        TOKEN_OVER = 411,
        TOKEN_WIN_MAGIC = 412
      };
    };
...
#line 3651 "/home/lighthouse/CatDB/sql/parser/sql_parser.hpp" // lalr1.cc:377
